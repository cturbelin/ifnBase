...
* `whith_ggplot()` init ggplot2 package with a default theme
* `gg_barplot_percent()` to create barplot with percentage
* `plot_age_pyramid()` to create population age pyramid with ggplot2
* `scale_x_wid` to create scales for weekly data, using a weeks dictionnary (create using make_week_index())
