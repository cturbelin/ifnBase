...
To work these functions need the surveys to be registered to the package. This part is described in a dedicated vignette [survey-definition](survey-definition.html).
...
In the resulting data.frame variable names names will be the *internal aliases* defined in the [survey definition](survey-definition.html)
...
The mapping between the database column names and variable names is defined in the survey [survey definition](survey-definition.html).
...
## Variable groups and survey_labels()
...
## survey_definition()
You can get all the configuration of a survey by calling survey_definition(). It will show all variable aliases, label recodings, and other parameters of a survey.
